...
Vue.registerElement(
  'RadCartesianChart',
  () => require('nativescript-ui-chart').RadCartesianChart
);
Vue.registerElement(
  'RadPieChart',
  () => require('nativescript-ui-chart').RadPieChart
);
Vue.registerElement(
  'RadLegendView',
  () => require('nativescript-ui-chart').RadLegendView
);
Vue.registerElement(
  'LineSeries',
  () => require('nativescript-ui-chart').LineSeries
);
Vue.registerElement(
  'PieSeries',
  () => require('nativescript-ui-chart').PieSeries
);
Vue.registerElement(
  'DonutSeries',
  () => require('nativescript-ui-chart').DonutSeries
);
Vue.registerElement(
  'AreaSeries',
  () => require('nativescript-ui-chart').AreaSeries
);
Vue.registerElement(
  'CategoricalAxis',
  () => require('nativescript-ui-chart').CategoricalAxis
);
Vue.registerElement(
  'LinearAxis',
  () => require('nativescript-ui-chart').LinearAxis
);
Vue.registerElement(
  'DateTimeCategoricalAxis',
  () => require('nativescript-ui-chart').DateTimeCategoricalAxis
);
Vue.registerElement(
  'SplineSeries',
  () => require('nativescript-ui-chart').SplineSeries
);
Vue.registerElement(
  'BarSeries',
  () => require('nativescript-ui-chart').BarSeries
);
Vue.registerElement(
  'RangeBarSeries',
  () => require('nativescript-ui-chart').RangeBarSeries
);
Vue.registerElement(
  'BubbleSeries',
  () => require('nativescript-ui-chart').BubbleSeries
);
Vue.registerElement(
  'ScatterBubbleSeries',
  () => require('nativescript-ui-chart').ScatterBubbleSeries
);
Vue.registerElement(
  'ScatterSeries',
  () => require('nativescript-ui-chart').ScatterSeries
);
Vue.registerElement(
  'OhlcSeries',
  () => require('nativescript-ui-chart').OhlcSeries
);
Vue.registerElement(
  'CandlestickSeries',
  () => require('nativescript-ui-chart').CandlestickSeries
);
Vue.registerElement(
  'RadCartesianChartGrid',
  () => require('nativescript-ui-chart').RadCartesianChartGrid
);
Vue.registerElement('Palette', () => require('nativescript-ui-chart').Palette);
Vue.registerElement(
  'PaletteEntry',
  () => require('nativescript-ui-chart').PaletteEntry
);
Vue.registerElement(
  'ChartGridLineAnnotation',
  () => require('nativescript-ui-chart').ChartGridLineAnnotation
);
Vue.registerElement(
  'ChartPlotBandAnnotation',
  () => require('nativescript-ui-chart').ChartPlotBandAnnotation
);
Vue.registerElement(
  'Trackball',
  () => require('nativescript-ui-chart').Trackball
);
Vue.registerElement(
  'PointLabelStyle',
  () => require('nativescript-ui-chart').PointLabelStyle
);
Vue.registerElement(
  'DateTimeContinuousAxis',
  () => require('nativescript-ui-chart').DateTimeContinuousAxis
);
Vue.registerElement(
  'LogarithmicAxis',
  () => require('nativescript-ui-chart').LogarithmicAxis
);
Vue.registerElement(
  'SplineAreaSeries',
  () => require('nativescript-ui-chart').SplineAreaSeries
);
